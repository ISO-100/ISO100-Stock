...
def main():
    ...
    for stk_num ,stk_name in stk_num_name:
        ...
        #Initialize 
        eps_y16_evg = y15_to_y16_growth = org_predict_pe = org_predict_peg = target_price = mid_value = target_price_range = "N/A"
        ...
        c.execute('''REPLACE INTO rst_stk_flt (
                stk_num,stk_name,mid_value,target_price_range,eps_y16_evg,y15_to_y16_growth,org_predict_pe,org_predict_peg,target_price)
